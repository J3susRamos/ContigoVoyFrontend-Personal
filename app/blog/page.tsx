...
async function getBlogData() {
  ...
  console.log(
    "🔍 [getBlogData] NEXT_PUBLIC_API_URL:",
    process.env.NEXT_PUBLIC_API_URL,
  );

  try {
    // Removed build-time blocking logic for Dokploy compatibility
    // The APIs should be available during build time in production
