...
export default function BlogPageComponent({
  ...
  const prevModalImage = useCallback(() => {
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-[#f8f9ff] via-[#f0f2ff] to-[#e8ebff] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            <div className="container mx-auto px-4 py-6 lg:py-8">
                ...
                <div className="mb-8">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl">
                                Descubre artículos sobre bienestar mental, desarrollo personal y salud emocional
                    ...
                    {(activeCategory || activeAuthor || searchTerm) && (
                        <div
                            className="flex flex-wrap items-center gap-3 mt-6 p-4 bg-white/50 dark:bg-gray-800/50 rounded-2xl backdrop-blur-sm">
                            <span
                                className="text-sm font-medium text-gray-600 dark:text-gray-300">Filtros activos:</span>
                            {activeCategory && (
                                <span
                ...
                {selectedBlog ? (
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <article
                            className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden">
                            {/* Article Header */}
                            <div
                                className="bg-gradient-to-r from-[#634AE2] via-[#7c3aed] to-[#8b7cf6] p-8 lg:p-12 text-white">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                        ...
                        <div className={`lg:col-span-1 ${showFilters ? 'block' : 'hidden'} lg:block`}>
                            <div className="sticky top-6">
                                <div
                                    className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-xl p-6 border border-[#634AE2]/10">
                                    <BlogAside
                        ...
                        <div className="lg:col-span-3">
                            {filteredData.length > 0 ? (
                                ...
                                <div className="text-center py-20">
                                    <div
                                        className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-xl p-12 border border-[#634AE2]/10">
