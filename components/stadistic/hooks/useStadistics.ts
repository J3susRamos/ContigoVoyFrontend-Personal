...
export default function useStadistics() {
  ...
  const getButtonClasses = (isActive: boolean) => {
    const baseClasses = "w-full md:w-auto inline-flex items-center justify-center gap-2 whitespace-nowrap shadow h-10 md:h-11 text-sm md:text-base font-semibold rounded-full px-4 md:px-8 py-2 transition-all duration-200 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2";
