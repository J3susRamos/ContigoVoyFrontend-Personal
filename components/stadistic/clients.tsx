    ...
    return (
        <div className="w-full max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8">
                ...
                <div
                    className="w-full bg-card dark:bg-card text-card-foreground dark:text-card-foreground rounded-2xl p-4 lg:p-6 flex flex-col">
                    <div
                    ...
                    <div className="flex justify-center gap-6 mt-4">
                        {genero.map((entry, index) => (
                            <div key={index} className="flex items-center gap-2">
                                ...
                                ></div>
                                <span
                                    className="text-primary dark:text-primary-foreground font-normal text-sm md:text-base">{entry.name}</span>
                            </div>
                        ))}
                    </div>
                </div>
