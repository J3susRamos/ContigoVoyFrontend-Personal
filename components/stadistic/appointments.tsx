...
export default function Appointments() {
    ...
    const fetchCitas = async (): Promise<CitaMensual[] | undefined> => {
        try {
          return await GetCitasTotalesConFecha();
        } catch (error) {
            console.error("Error al cargar las citas con fecha", error);
        }
    };
    useEffect(() => {
        ...
        <div className="w-full max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                ...
                <div className="w-full bg-card dark:bg-card rounded-2xl p-4 lg:p-6 flex flex-col">
                    <div
                        className="rounded-r-full w-full max-w-[300px] h-[50px] md:h-[60px] bg-primary dark:bg-primary mb-4 flex items-center justify-center">
