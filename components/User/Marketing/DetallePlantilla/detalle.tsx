    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 px-6 pb-10">
                <section
                    className="lg:col-span-2 bg-gray-100 dark:bg-gray-800 rounded-xl p-8 shadow-xl border border-gray-300 dark:border-gray-700">
                ...
                {/* Vista previa */}
                <aside
                    className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 shadow-xl border border-gray-300 dark:border-gray-700">
                    ...
                    <div
                        className="bg-white dark:bg-gray-700 rounded-lg p-6 min-h-[300px] border-2 border-dashed border-gray-300 dark:border-gray-600">
                        {emailBlocks.length ? (
