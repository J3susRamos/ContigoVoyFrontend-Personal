  ...
  return (
    <div className="relative dark:from-gray-800 dark:to-gray-900 bg-gradient-to-r from-blue-50 to-purple-50">
      <section className="relative overflow-hidden bg-gradient-to-br from-[#634AE2] via-[#9494F3] to-[#7B5FE8] dark:from-purple-900 dark:via-indigo-800 dark:to-blue-900 h-[700px] sm:h-[700px] flex items-center">
        ...
        </div>        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-12 lg:py-20">          <div className="flex xl:grid xl:grid-cols-2 flex-col gap-8 items-center min-h-[480px] sm:min-h-[400px]">            {/* Left content */}
            <div className="text-center xl:text-left space-y-6 sm:space-y-8 order-1 xl:order-1">
              {/* Content background container */}              <div className="bg-black/30 backdrop-blur-sm rounded-3xl p-4 sm:p-6 border border-white/20 shadow-2xl max-w-4xl w-full mx-auto min-h-[320px] sm:min-h-[380px] flex flex-col justify-between">{/* Service badges */}
                <motion.div
                ...
                >
                  {service.motto}
                </motion.h1>                {/* Call to action buttons */}
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
      ...
      <div className="my-scv9 px-scv3 sm:px-scv6 flex justify-center">
        ...
        </div>        {/* Flotante de cita gratuita eliminado por solicitud del usuario */}
    </div>
  );
}
